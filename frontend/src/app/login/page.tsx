          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1.5">
                {selectedRole === 'admin' ? 'Admin Username / Email' : 'Agent Username or Employee ID (e.g. AGT-001)'}
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={selectedRole === 'admin' ? 'admin' : 'Enter agent username or employee ID'}
                  required
